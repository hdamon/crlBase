classdef windowPlot < crlBase.gui.uipanel
  ...
  %
  % Param-Value Pairs:
  %   tVals : x-Axis Values for Each of the N Samples
  %
  % Events:
  ...
  properties (Dependent = true, Hidden = true)
    ...
    windowtVals  % Deprecated. Replacement is obj.windowSeries.tVals
  end
  ...
  methods
    function obj = windowPlot(timeseries,varargin)
      ...
      obj.zoomButtons = crlBase.gui.widget.dualbutton(...
        'parent',obj.panel,...
        'leftLabel','-',...
        'rightLabel','+',...
        'title','Zoom');
      ...
      obj.shiftButtons = crlBase.gui.widget.dualbutton(...
        'parent',obj.panel,...
        'title','Shift');
      ...
      obj.selButtons = crlBase.gui.widget.dualbutton(...
        'parent',obj.panel,...
        'title','Select',...
        'leftLabel','Start',...
        'rightLabel','End');
      ...
      %% Set Data, tVals, and initial windowPlot size, then draw
    ...
    function shiftWindow(obj,val)
      ...
      % Inputs
      % ------
      %    obj : crlBase.type.timeseries.interface.windowPlot object
    ...
    function nearest = sampleNum(obj,val)
      ...
      %
      nearest = abs(val-obj.timeseries.tVals);
    ...
    function setWindow(obj,windowStart,windowEnd)
      ...
      if isa(windowStart,'crlBase.gui.timeseries.interface.windowPlot')
    ...
    function out = get.windowData(obj)
      ...
      warning(['crlBase.type.timeseries.interface.windowPlot.windowData '...
        'is deprecated. Use '...
        'crlBase.type.timeseries.interface.windowPlot.windowSeries ' ...
        'instead.']);
      out = obj.windowSeries;
    end
    
    function out = get.windowtVals(obj)
      % Get method for deprecated property
      warning('This functionality is deprecated. use obj.windowSeries.tVals instead');
      out = obj.timeseries.tVals(obj.windowStart:obj.windowEnd);
    end
    ...
    function updateImage(obj)
      ...
      %crlBase.type.timeseries.render.butterfly(obj.timeseries,'ax',obj.axes);
      
      % Catch zero-length X axes definitions.
      XLim(1) = obj.timeseries.tVals(1); XLim(2) = obj.timeseries.tVals(end);
      if (XLim(1)==XLim(2)),
        XLim(1) = XLim(1) - 0.1;
        XLim(2) = XLim(2) + 0.1;
      end;
    ...
    function drawLines(obj)
      ...
      axes(obj.axes);
      hold on;
      XVal = obj.timeseries.tVals([obj.windowStart obj.windowEnd]);
      YLim = get(obj.axes,'YLim');
    ...
    function set.timeseries(obj,val)
      % Set Method for crlBase.type.timeseries.interface.windowPlot
      %
      %
      
      % Input Checking
      if isempty(val), obj.timeseries_ = []; return; end;
      crlBase.util.assert.instanceOf('crlBase.type.timeseries',val);
